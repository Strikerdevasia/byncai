...
# Access the database credentials stored in Streamlit's secrets
db_user = st.secrets["root"]
db_password = st.secrets["Alwin1234!"]
db_host = st.secrets["localhost"]
db_name = st.secrets["MYSQL80"]
...
try:
    ...
    st.write(f"Connected to database: {database_name[0]}")
